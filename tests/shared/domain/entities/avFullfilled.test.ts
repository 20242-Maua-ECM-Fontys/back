...
describe('AvFullfilled entity', () => {
  it('should create an AvFullfilled entity', () => {
    ...
    expect(avFullfilled.props.availabilityId).toBe(
      '0a8c5357-1f07-5b24-9845-9318c4000000',
    )
    expect(avFullfilled.props.possibilityId).toBe(
      '0a8c5357-1f07-5b24-9845-9318c4000001',
    )
    expect(avFullfilled.props.classId).toBe(
      '0a8c5357-1f07-5b24-9845-9318c4000002',
    )
  })

  it('Should create an AvFullfilled entity with roomCode', () => {
    const avFullfilled = new AvFullfilled({
      availabilityId: '0a8c5357-1f07-5b24-9845-9318c4000000',
      possibilityId: '0a8c5357-1f07-5b24-9845-9318c4000001',
      classId: '0a8c5357-1f07-5b24-9845-9318c4000002',
    ...
    expect(avFullfilled.props.roomCode).toBe('A01')
  })
